const QUESTION_BANK = [
  ...
  { 
    ...
    choices: ["총계처리", "가명처리", "데이터 범주화", "데이터 마스킹"],
    ans: 2,
    exp: "데이터 범주화(Data Generalization) 기법으로, 구체적인 식별 값('901111-1234567')을 '90년대 생, 남자'처럼 포괄적인 범주로 대체하여 개인을 특정하지 못하게 합니다. 데이터 삭제는 식별자를 아예 제거하는 기법이며, 범주화는 값을 유지하되 더 넓은 범위로 일반화하는 차이가 있습니다."
  },
  { 
    subj: 1, 
